...
// Mirrors the live "Alapanyagok" sheet (ING01-ING35) with web-verified macros
// (salmon, oat flour, whey, trappista, túró corrected). Keep this in sync with
// the Google Sheet so the offline fallback matches reality.
const DEFAULT_INGREDIENTS_CSV = `"Azonosító","Alapanyag","kcal/100g","Fehérje/100g","Szénhidrát/100g","Zsír/100g","Kiszerelés","Kiszerelés (g)","Bolt","Forrás/Megjegyzés"
"ING01","Milbona skyr natúr",63,11,4,0.2,"250g pohár",250,"Lidl","Forrás: dine4fit"
"ING02","Whey fehérjepor (Nutriversum Whey Pro)",374,75,9.7,3.6,"30g adag",30,"Bármely","Forrás: Nutriversum hivatalos címke"
"ING03","Lazacfilé (nyers)",208,20,0,13,"~150g filé",150,"Lidl/Spar/Tesco","Forrás: USDA tenyésztett atlanti lazac (nyers)"
"ING04","Darált pulyka (vegyes)",140,19,0,7,"~500g tálca",500,"Tesco/Spar","Forrás: átlag vegyes darált pulyka"
"ING05","Csirkemell (nyers)",110,23,0,1.5,"~500g",500,"Bármely","Forrás: USDA nyers csirkemell"
"ING06","Kovászos kenyér (házi)",255,9,50,1.5,"~750g cipó",750,"Házi","Forrás: átlag kovászos kenyér"
"ING07","Edamame bab (kifejtett, fagyasztott)",120,11,9,5,"500g zacskó",500,"Lidl","Forrás: USDA edamame shelled"
"ING08","Tojás (M méret)",134,12.6,1.1,9.5,"10 db doboz",580,"Bármely","Forrás: USDA; 1 db M ~58g"
"ING09","Sovány sonka",112,20,1,2.5,"100g csomag",100,"Bármely","Forrás: átlag sovány sonka"
"ING10","Trapista sajt",352,24,1,28,"~200g",200,"Bármely","Forrás: átlag trappista (web-ellenőrzött)"
"ING11","Félzsíros túró",137,16,3,7,"250g",250,"Bármely","Forrás: átlag félzsíros túró (web-ellenőrzött)"
"ING12","Zabpehely",375,13,60,7,"500g",500,"Bármely","Forrás: átlag zabpehely"
"ING13","Banán",90,1.1,23,0.3,"1 db ~120g",120,"Bármely","Forrás: USDA banán"
"ING14","Vegyes bogyós gyümölcs (fagyasztott)",45,1,10,0.3,"300g zacskó",300,"Lidl/Tesco","Forrás: átlag bogyós mix"
"ING15","Spar Obstpause gyümölcssnack",60,0,14,0,"~100g tasak",100,"Spar","BECSLÉS – címkén ellenőrizni!"
"ING16","Fehér rizs (száraz)",358,7,78,0.8,"1000g",1000,"Bármely","Forrás: USDA száraz rizs"
"ING17","Teljes kiőrlésű tészta (száraz)",350,14,68,2.5,"500g",500,"Bármely","Forrás: átlag tk tészta"
"ING18","Édesburgonya",86,1.6,20,0.1,"~1000g",1000,"Bármely","Forrás: USDA édesburgonya"
"ING19","Brokkoli",34,2.8,7,0.4,"~500g",500,"Bármely","Forrás: USDA brokkoli"
"ING20","Teljes kiőrlésű tortilla",310,9,50,7,"6 db csomag",360,"Bármely","Forrás: átlag tk tortilla; 1 db ~60g"
"ING21","Light tzatziki",80,3,5,5,"200g",200,"Bármely","Forrás: átlag light tzatziki"
"ING22","Csicseriborsó (főtt/konzerv)",164,9,27,2.6,"400g konzerv",400,"Bármely","Forrás: USDA főtt csicseri"
"ING23","Kókusztej (light)",75,1,3,6,"400ml konzerv",400,"Bármely","Forrás: átlag light kókusztej"
"ING24","Vörösbab (főtt/konzerv)",94,6,16,0.5,"400g konzerv",400,"Bármely","Forrás: USDA főtt bab"
"ING25","Kukorica (konzerv)",80,2.5,15,1,"285g konzerv",285,"Bármely","Forrás: átlag konzerv kukorica"
"ING26","Dió",654,15,14,65,"200g",200,"Bármely","Forrás: USDA dió"
"ING27","Cottage cheese",98,11,3.4,4.3,"200g",200,"Bármely","Forrás: átlag cottage cheese"
"ING28","Tonhalkonzerv (vízben)",116,26,0,1,"160g konzerv",160,"Bármely","Forrás: átlag tonhal vízben; lecsöpögtetve"
"ING29","Liszt (finomliszt)",345,10,72,1.2,"1000g",1000,"Bármely","Forrás: átlag búzaliszt"
"ING30","Zabliszt",400,15,65,7,"500g",500,"Bármely","Forrás: átlag zabliszt (web-ellenőrzött)"
"ING31","Étolaj (napraforgó)",884,0,0,100,"1000ml",1000,"Bármely","Forrás: USDA olaj; 1 tk ~5g"
"ING32","Granola",450,9,65,15,"500g",500,"Bármely","Forrás: átlag granola"
"ING33","Protein kávé alapanyag (whey 20g)",374,75,9.7,3.6,"lásd ING02",30,"-","20g whey vízzel/kávéval"
"ING34","Vegyes wokzöldség (fagyasztott)",33,2,5,0.4,"450g zacskó",450,"Bármely","Forrás: átlag wokzöldség mix"
"ING35","Friss zöldség (saláta/paradicsom/uborka)",18,1,3,0.2,"~100g",100,"Bármely","Forrás: átlag vegyes zöldség"`;
